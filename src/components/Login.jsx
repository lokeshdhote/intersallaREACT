...
import { userSignIN } from '../store/Reducers/userSlice';
            ...
            </div>
          {
           ...
           <div className='flex flex-col items-center'>
                    ...
                    <div className='mt-4'>
                        ...
                        <input onChange={(e)=> setpassword(e.target.value)} value={password} name='password' className='py-[6px] mt-1 w-[46vh] rounded px-3 border-[1px] outline-[3px] outline-none focus:border-[#00A5EC] border-zinc-300' placeholder='password must be strong' type="text" />
                    </div>
           </div>
