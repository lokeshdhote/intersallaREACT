    ...
    <>
     ...
     {isLoginpage && <Login setlogin={setisLoginpage} ></Login>}
      <div className='relative  min-h-[100vh]  py-[15%] lg:py-[5%] '>
        ...
        <form onSubmit={Employsignup} className='w-[90%]  lg:w-[25%] lg:float-right lg:mr-6 lg:mt-0 m-auto mt-5  shadow-blue-300 border rounded-xl h-[80vh] lg:h-[90vh] bg-white  shadow-md p-3'>
           ...
           <div className='flex flex-col items-center w-full'>
                    <div className='w-full'>
                        ...
                        <input onChange={(e)=>setemail(e.target.value)} value={email}  className='py-[8px] mt-1 w-full rounded px-3 border-[1px] outline-[3px] outline-none focus:border-[#00A5EC] border-zinc-300' placeholder='aa@gmail.com' type="text" />
                    <div className='mt-4 w-full'>
                        <h2 className='font-medium text-zinc-700'>Password</h2>
                    </div>
                        <input onChange={(e)=>setpassword(e.target.value)} value={password}  className='py-[8px] mt-1 w-full rounded px-3 border-[1px] outline-[3px] outline-none focus:border-[#00A5EC] border-zinc-300' placeholder='password must be strong' type="text" />
                    <div className='mt-4 w-full'>
                        <h2 className='font-medium text-zinc-700'>Contact</h2>
                    </div>
                        <input onChange={(e)=>setcontact(e.target.value)} value={contact}  className='py-[8px] mt-1 w-full rounded px-3 border-[1px] outline-[3px] outline-none focus:border-[#00A5EC] border-zinc-300' placeholder='Your mobile number' type="text" />
                    <div className='mt-4 w-full'>
                        <h2 className='font-medium text-zinc-700'>Organization</h2>
                    </div>
                        <input onChange={(e)=>setOrganization(e.target.value)} value={Organization}  className='py-[8px] mt-1 w-full rounded px-3 border-[1px] outline-[3px] outline-none focus:border-[#00A5EC] border-zinc-300' placeholder='Organization name' type="text" />
                    <div className='mt-4 w-full flex gap-10'>
                       <div>
                          <h2 className='font-medium text-zinc-700'>First Name</h2>
                       </div>
                            <input onChange={(e)=>setfirstname(e.target.value)} value={firstname}  className='py-[8px] mt-1 w-full rounded px-3 border-[1px] outline-[3px] outline-none focus:border-[#00A5EC] border-zinc-300' placeholder='jhon' type="text" />
                       <div>
                          <h2 className='font-medium text-zinc-700'>Last Name</h2>
                       </div>
                            <input onChange={(e)=>setlastname(e.target.value)} value={lastname}  className='py-[8px] mt-1 w-full rounded px-3 border-[1px] outline-[3px] outline-none focus:border-[#00A5EC] border-zinc-300' placeholder='doe' type="text" />
                    </div>
