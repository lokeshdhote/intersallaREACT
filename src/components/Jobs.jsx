...
import { asyncReadJob } from '../store/Actions/employeeAction';
...
const dispatch = useDispatch()
  useEffect(()=>{
    ...
    const job = useSelector((state)=>state.employee.job.jobs)
    console.log(job);
  ...
  return (
    <>
     ...
     <div className='search relative mt-2 '>
      ...
      <div className='w-full py-[25%] lg:py-[8%] px-3 bg-[#F8F8F8]  overflow-y-scroll'>
            ...
            <h2 className='text-center font-semibold lg:text-xl'>job</h2>
    ...
    job.map((job,index)=>{
      return( <>
     <div  key={index} className='border mt-2  p-5 flex-col items-start justify-start py-5 lg:rounded-[15px]  rounded-md shadow-lg bg-white' >
      { }
                                    <h2 className='font-medium text-[2vh] lg:text-[2.5vh]'>{job?.title}</h2>
                                    ...
                                    <div className='w-[100%] text-left py-2 lg:flex lg:items-baseline lg:gap-3'>
                                        <h3 className='text-[1.6vh] lg:text-[2vh] text-zinc-500 font-medium'>{job?.jobtype} - {job?.jobtime}</h3>
                                    ...
                                    <div>
                                    <h3 className='text-[1.6vh] lg:text-[2vh] text-zinc-500 font-medium'>{job?.openings} -Openings </h3>
                                     </div>
                                    ...
                                    <div className='loc text-zinc-600 pt-5 lg:flex lf lg:gap-3 '>
                                        ...
                                        <h2 className='text-[15px] lg:text-[1.8vh]  font-medium flex items-center gap-2'><CiLocationOn className='font-bold scale-[1.2]' /> {job?.city}</h2>
